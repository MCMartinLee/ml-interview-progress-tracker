...
export const PLAN = [
  day(1,"2026-07-16","Thursday",1,"Setup and ML Landscape",{
    ...
    C:["Read docs/sprint_detailed_guide.html#day-1 for exact Day 1 steps","Create your own prep folders: prep/ml, prep/llm, prep/agents, prep/system_design, prep/leetcode, prep/behavioral, prep/job_search","Clone or bookmark approved resources and record them in prep/resources.md","Create prep/ml/notebooks/day01_setup_and_eda.ipynb and inspect one dataset or record the setup blocker","Commit your prep work with message day01_setup_and_eda"],
