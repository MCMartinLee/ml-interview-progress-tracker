...
export const PLAN = [
  day(1,"2026-07-13","Monday",1,"Setup and ML Landscape",{
  ...
  day(2,"2026-07-14","Tuesday",1,"End-to-End ML Pipeline",{
  ...
  day(3,"2026-07-15","Wednesday",1,"Classification and Evaluation",{
    ...
    I:["Record Tell me about yourself","Record Why this role and Why this company","Review filler words, chronology, and unnecessary detail"],
  ...
  day(4,"2026-07-16","Thursday",1,"Linear Models and Week 1 Deliverable",{
  ...
  day(5,"2026-07-17","Friday",1,"Week 1 Review and Buffer",{
  ...
  day(6,"2026-07-18","Saturday",2,"Decision Trees",{
  ...
  day(7,"2026-07-19","Sunday",2,"Ensembles",{
    ...
    I:["LeetCode 704 — Binary Search","Write closed and half-open interval versions","Explain loop invariant and termination","Test boundaries and missing targets"],
  ...
  day(8,"2026-07-20","Monday",2,"Dimensionality Reduction",{
  ...
  day(9,"2026-07-21","Tuesday",2,"Unsupervised Learning",{
  ...
  day(10,"2026-07-22","Wednesday",2,"Artificial Neural Networks",{
    ...
    I:["System design: URL shortener","Cover requirements, estimates, high-level design, data model, APIs, scaling, and self-critique"],
  ...
  day(11,"2026-07-23","Thursday",2,"PyTorch and Week 2 Deliverable",{
    ...
    I:["Record ownership, failure/risk, collaboration/conflict, and ambiguity stories","Use STAR","Keep each initial answer under three minutes"],
  ...
  day(12,"2026-07-24","Friday",2,"Week 2 Review and Buffer",{
    ...
    I:["Redo LeetCode 53, 704, or 238","Run ML theory lightning round","Deliver one behavioral story with follow-ups"],
  ...
  day(13,"2026-07-25","Saturday",3,"Tokenization and Data Loading",{
    ...
    I:["LeetCode 56 — Merge Intervals","Define overlap condition","Explain sorting requirement","Test contained, touching, disjoint, and empty inputs"],
  ...
  day(14,"2026-07-26","Sunday",3,"Attention",{
    ...
    I:["LeetCode 3 — Longest Substring Without Repeating Characters","Implement set and last-index map versions","State sliding-window invariant","Explain why left never moves backward"],
  ...
  day(15,"2026-07-27","Monday",3,"GPT Architecture",{
    ...
    I:["Explain transformer end to end","Answer complexity, encoder vs. decoder, training vs. generation, positions, KV cache, and long-context follow-ups"],
  ...
  day(16,"2026-07-28","Tuesday",3,"Pretraining and nanoChat",{
  ...
  day(17,"2026-07-29","Wednesday",3,"Fine-Tuning and Research Deep Dive",{
    ...
    I:["Research deep dive: problem, data, labels, architecture, training, evaluation, ablations, failures, deployment, and hostile follow-ups","Use multiparty turn-dynamics work as the primary example"],
  ...
  day(18,"2026-07-30","Thursday",3,"Instruction Fine-Tuning and Week 3 Deliverable",{
    ...
    I:["System design: Twitter timeline and search","Cover fan-out, caching, feeds, search indexing, availability, and failures"],
  ...
  day(19,"2026-07-31","Friday",3,"Week 3 Review and Buffer",{
    ...
    I:["Run 30-minute transformer mock","Run 30-minute research deep dive","Require follow-ups on decisions, negative results, and alternatives"],
  ...
  day(20,"2026-08-01","Saturday",4,"Agent Fundamentals and Tool Use",{
    ...
    I:["LeetCode 33 — Search in Rotated Sorted Array","Identify sorted half","Explain target-range decision","Test pivot, boundaries, missing, and single-element cases"],
  ...
  day(21,"2026-08-02","Sunday",4,"Agentic RAG",{
    ...
    I:["System design: Web crawler","Cover URL frontier, deduplication, politeness, workers, storage, failures, and scaling"],
  ...
  day(22,"2026-08-03","Monday",4,"Trust, Planning, and Multi-Agent Patterns",{
    ...
    I:["LeetCode 200 — Number of Islands","Implement DFS and optionally BFS","Explain visited mutation","Test empty and disconnected grids"],
  ...
  day(23,"2026-08-04","Tuesday",4,"Protocols, Context, and Memory",{
    ...
    I:["Design a job-discovery agent","Cover state, tools, permissions, deduplication, ranking, memory, approval, failure recovery, and evaluation"],
  ...
  day(24,"2026-08-05","Wednesday",4,"ML System Design",{
    ...
    I:["LeetCode 322 — Coin Change","Define state and recurrence","Compare top-down and bottom-up","Explain unreachable state","Test zero and impossible amounts"],
  ...
  day(25,"2026-08-06","Thursday",4,"Final Integration and Deliverable",{
    ...
    I:["LeetCode 973 — K Closest Points to Origin","Run ML theory follow-ups","Run research deep dive","Run system-design scaling follow-ups","Use no notes"],
